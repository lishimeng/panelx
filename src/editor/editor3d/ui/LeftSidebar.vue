...
let worldScale = defineModel<any>('worldScale', { required: true })
let worldSizeZ = defineModel<any>('worldSizeZ', { required: true })
let designCoord = defineModel<any>('designCoord', { required: true })
let sceneLights = defineModel<any>('sceneLights', { required: true })
let bloomStrength = defineModel<any>('bloomStrength', { required: true })
let bloomRadius = defineModel<any>('bloomRadius', { required: true })
let bloomThreshold = defineModel<any>('bloomThreshold', { required: true })
let cameraPosition = defineModel<any>('cameraPosition', { required: true })
let cameraLookAt = defineModel<any>('cameraLookAt', { required: true })
let cameraZoom = defineModel<any>('cameraZoom', { required: true })
let editorBackgroundColor = defineModel<any>('editorBackgroundColor', { required: true })
